...
class SimulatedAnneal(object):
    ...
    def fit(self, X, y):
        ...
        if self.__n_jobs > 1:
            ...
            old_score, old_std = CVFolds(
                old_est, scorer=score_func, cv=cv).fit_score(X, y)
        ...
        while T > T_min and total_iter < max_iter and t_elapsed < max_runtime and new_score < self.__max_score:
            ...
            while iter_ < n_trans and new_score < self.__max_score:
                ...
                if hasattr(val, 'rvs'):
                    ...
                    sampel_space = [v for v in grid[rand_key]
                ...
                try:
                    ...
                    # params
                    new_score, new_std = states_checked[
                        tuple(sorted(new_params.items()))]
                except:
