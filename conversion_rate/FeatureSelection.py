...
def main(temp, clf, CrossMethod, RecordFolder, test = False):
    ...
    file = 'round2_preprocess_0425.txt'
    ...
    ColumnName = ['shop_review_num_level', 'shop_review_positive_rate', 'shop_score_delivery', 'shop_score_description', 
                  'shop_score_service', 'shop_star_level', 'user_age_level', 'user_gender_id', 'user_occupation_id', 
                  'user_star_level', 'hour']
    print(ColumnName)
    # start selecting
...
if __name__ == "__main__":
    ...
    temp = ['shop_score_delivery', 'shop_score_description', 'shop_score_service'] # start features combination
