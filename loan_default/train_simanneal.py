...
# best parameters:  {'num_leaves': 14, 'max_depth': 5, 'subsample': 0.71899999999999997, 'colsample_bytree': 0.71799999999999997}
...
# best parameters:  {'num_leaves': 18, 'max_depth': 6, 'subsample': 0.71930000000000005, 'colsample_bytree': 0.71779999999999999}
...
def simAnneal(Train, predictors, target, param, results=True):
    ...
    sa = optimize.SimulatedAnneal(gbm, param, T=10.0, T_min=0.001, alpha=0.75,
...
def main():
    ...
    optimized_clf = simAnneal(dtrain, predictors, target, param = param_4)
